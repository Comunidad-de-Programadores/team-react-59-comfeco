        ...
        <div className="containerSesion row between-md center-xs">
          <div className="containerText col-xs-12 col-md-5 ">
            ...
            <div className="containerP row">
              <span className="ico icon-check-circle col-xs-2 col-md-1"></span>
              <p className="col-xs-10 col-md-11">
                Si estas en el Team Angular no podrás presentar el proyecto en
                un framework distinto, así para cada uno de los casos.
              </p>
            </div>
            <div className="containerP row">
              <span className="ico icon-check-circle col-xs-2 col-md-1"></span>
              <p className="col-xs-10 col-md-11">
                ...
                tiempo extra, por eso la fecha se les dirá con mucha
                anticipación.
              </p>
            </div>
            <div className="containerP row">
            ...
            <div className="containerP row">
              ...
              <p className="col-xs-10 col-md-11">
                ...
                estarán como guía para dar algunos talleres y resolver dudas
                para poder completar con éxito el proyecto.
              </p>
            </div>
