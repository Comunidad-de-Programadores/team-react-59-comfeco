...
const Home = () => {
    return (  <>
        <main>
          ...
          <div className="containerSesion logueado row center-xs">
            <div className="welcome row col-xs-12 center-xs">
              <h1>Bienvenidos <b>comfeco</b> <br/>¡Community Fest and Code!</h1>
              <h3 className="col-xs-12">¡Conoce gente, aprende y gana!</h3>
              <div className="text">
                <p>
