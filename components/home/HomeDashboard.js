...
const HomeDashboard = () => {
  const timer = <Counter deadline={5050505050}></Counter>;
  return (
    <>
      <div className="content row col-xs-12" id="content">
        ...
        <div className="containerPaneles row col-xs-12 around-xs">
          ...
          <div className="panelTimer col-xs-5 timeLg">{timer}</div>
          <div className="panelTaller">
            <Workshops />
          </div>
        </div>
        <div className="timeXs">
          <div className="panelTimer col-xs-9 ">{timer}</div>
        </div>

        <div className="panelSponsor">{<CorouselSponsors />}</div>
      </div>
    </>
  );
};
